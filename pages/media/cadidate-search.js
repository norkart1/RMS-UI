...
const DisplayCandidates = (props) => {
  ...
  searchResult?.map((candidate) => {
    array.push({
      value: candidate.candidate_chest_no,
      label: candidate.candidate_chest_no + " " + candidate.candidate_name,
    });
  });
          ...
          return (
            ...
            >
              ...
              <p style={{ fontWeight: "bold", textAlign: "center" }}>
                {" "}
                {item.candidate_name} <br /> {prefix}
                {item.candidate_chest_no}{" "}
              </p>
