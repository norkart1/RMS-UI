    ...
    <div>
      ...
      <Layout openedTabName='leaderboard' style={{ background: 'linear-gradient(135deg, rgb(246 236 255) 10%, rgb(253 216 255 / 72%) 100%)' }}>
        <div className={s.box} style={{ paddingBottom: '0' }}>
          <h2 style={{ padding: '1rem', color: 'rgb(142 140 140)', width: '100%', textAlign: 'center' }}>INSTITUTES TOTAL POINTS<br />GENERAL </h2>
          <TopFiveInsti count={30} />
        </div>
        <div className={s.box} style={{ paddingBottom: '0' }}>
          <h2 style={{ padding: '1rem', color: 'rgb(142 140 140)', width: '100%', textAlign: 'center' }}>INSTITUTES TOTAL POINTS<br />NIICS </h2>
