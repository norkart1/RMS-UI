    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.quick_links}>
          ...
          <ul>
            ...
            <li className={styles.link} onClick={() => router.push('/public_portal/elimination_results')}>Results</li>
            <li className={styles.link} onClick={()=> router.push('/feeds')}>News</li>
            <li className={styles.link} onClick={()=> router.push('/')}>Notifications</li>
            <li className={styles.link} onClick={()=> router.push('/downloads')}>Programme schedule</li>
